                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @foreach ($CategorySelected as $CatSel)
                                  <a href="{{url('/')}}/admin/editCategories/{{$CatSel->id}}">
                                    <strong>{{$CatSel->title}}</strong>
                                </a>
                                @endforeach
                            </td>

                            <td><a href="{{url('/')}}/admin/editSubCategories/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            </td>
