        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Edit {{$Category->name}}</a>
                    </li>
                ...
                <form method="POST" action="{{url('/')}}/admin/edit_Category/{{$Category->id}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="list-title" name="title" type="text" value="{{$Category->name}}" class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <select name="identifier">
                                <option selected value="identifier">{{$Category->identifier}}</option>
