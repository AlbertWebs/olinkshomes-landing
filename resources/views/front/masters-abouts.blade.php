            ...
            <div id="header-wrap">
               <div class="container">
                  <div class="header-row">
                    <div id="logo">
                        <a href="{{url('/')}}" class="standard-logo" data-dark-logo="{{url('/')}}/olinkshomes/images/Olinks-Homes-Logo-Design-30.png"><img src="{{url('/')}}/olinkshomes/images/OlinksHomesLogoDesign-29.png" alt="Olinks Homes"></a>
